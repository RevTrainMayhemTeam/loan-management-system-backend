            ...
            steps {
                withCredentials([file(credentialsId: 'Loan-Management-System-SSHKeys', variable: 'EC2_KEY')]) {
                    sh '''
                        ...
                        scp -o StrictHostKeyChecking=no -i $EC2_KEY backend/Dockerfile ec2-user@54.144.224.97:/home/ec2-user/Loan-Management-System-Backend/
                        scp -o StrictHostKeyChecking=no -i $EC2_KEY backend/target/SpringTodoApp-0.0.1-SNAPSHOT.jar ec2-user@54.144.224.97:/home/ec2-user/Loan-Management-System-Backend/
                    '''
                }
            }
        }
